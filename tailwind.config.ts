  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 16px 48px rgba(0, 0, 0, 0.13), 0 4px 12px rgba(0, 0, 0, 0.06)',
        'premium': '0 24px 72px rgba(26, 61, 43, 0.18), 0 8px 24px rgba(26, 61, 43, 0.08)',
        'glow-primary': '0 0 40px rgba(74, 155, 111, 0.25)',
        'lift': '0 8px 32px rgba(0, 0, 0, 0.10), 0 2px 8px rgba(0, 0, 0, 0.06)',
        'button': '0 4px 16px rgba(74, 155, 111, 0.3), 0 1px 4px rgba(74, 155, 111, 0.15)',
      },
    },
  },
  plugins: [],
