...
export const DOCTORS_STATIC: Doctor[] = [
  {
    ...
    initials: 'SA',
    color: '#14202E',
    bio: 'Dr. Sachin Agrawal is the founder and lead dentist at Bright Smile Dental Clinic. With 24 years of experience across general dentistry, root canal treatment, prosthetic work and clear aligner therapy, he is known for his clinical precision and compassionate, patient-first approach — ensuring every visit is comfortable and every treatment plan is clearly explained.',
    specializations: ['General Dentistry', 'Root Canal Treatment', 'Prosthetic Works', 'Clear Aligners'],
    languages: ['Nepali', 'Hindi', 'English'],
    experience: '24 years',
    education: 'The Manipal College of Dental Sciences',
    visible: true,
    sortOrder: 1,
  },
  {
    ...
    initials: 'BA',
    color: '#3d8560',
    bio: 'Dr. Binita Adhikari is a lead dentist at Bright Smile Dental Clinic with 26 years of experience. Known for her expertise in restorative and cosmetic dentistry, she also focuses on the correction of malaligned teeth, with a gentle, patient-focused approach that eases dental anxiety and builds lasting confidence in every smile.',
    specializations: ['Restorative Dentistry', 'Cosmetic Dentistry', 'Preventive Care', 'Composite Fillings', 'Correction of Malaligned Teeth'],
    languages: ['Nepali', 'Hindi', 'English'],
    experience: '26 years',
  ...
  },
  {
    ...
    initials: 'RS',
    color: '#4A9B6F',
    bio: 'Dr. Ranjita Shrestha (Gorkhali) is a periodontist at Bright Smile Dental Clinic, NMC registered (NMC 11303).',
...
export const SERVICE_CATEGORIES_STATIC: ServiceCategory[] = [
  ...
  },
  {
    ...
    description: 'Our endodontic care treats infection and damage inside the tooth, relieving pain and saving teeth that would otherwise need extraction — from straightforward to complex root canal cases.',
    subServices: [
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'Pulpectomy', description: 'Complete removal of infected pulp from a primary tooth to relieve pain and save the tooth.' },
      { name: 'Pulpotomy', description: 'Partial removal of infected pulp to preserve a healthy primary tooth.' },
      { name: 'Pediatric Zirconia Crowns', description: 'Durable, tooth-coloured crowns for children\'s teeth.' },
...
export const CLINIC_STORY_STATIC = {
  ...
  whyChooseUs: [
    'All Nepal Medical Council registered dentists and specialists',
    '20+ years serving Kathmandu and surrounding communities',
...
export const WHY_CHOOSE_STATIC: WhyChooseReason[] = [
  {
    ...
    description: 'Nepal Medical Council registered dentists and specialists with decades of combined clinical experience in Kathmandu.',
    visible: true,
    sortOrder: 1,
  },
  {
