...
export const DOCTORS_STATIC: Doctor[] = [
  ...
  },
  {
    ...
    languages: ['Nepali', 'Hindi', 'English'],
    experience: '6+ years',
    education: 'City Dental College, Bangladesh',
    visible: true,
    sortOrder: 4,
  },
  {
  ...
  },
  {
    ...
    initials: 'RN',
    color: '#4A9B6F',
    bio: 'Dr. Rinky Nyachhyon specialises in oral medicine and dental radiology, playing a key role in accurate diagnosis. She uses advanced digital imaging to detect conditions early, supporting effective treatment planning across every specialty at Bright Smile.',
    specializations: ['Oral Medicine', 'Dental Radiology', 'Oral Diagnosis', 'Oral Pathology'],
    languages: ['Nepali', 'Hindi', 'English'],
    experience: '5+ years',
    education: 'MDS, Oral Medicine and Radiology, Manipal College of Medical Sciences, Pokhara',
    visible: true,
    sortOrder: 8,
  },
  {
