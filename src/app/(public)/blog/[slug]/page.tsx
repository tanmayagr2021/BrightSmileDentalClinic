      ...
      <div className="bg-tint border-b border-gray-100 py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-6">
            <Link href="/blog" className="font-body text-sm text-gray-400 hover:text-primary transition-colors">
              Blog
            </Link>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            {typedPost.published_at && (
              <span className="font-heading text-xs font-semibold text-gray-400">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[2fr_1fr]">
          <article className="max-w-none">
            {typedPost.content ? (
              ...
              <p className="font-body text-base text-gray-400 italic">No content available.</p>
            )}
                ...
                <div className="space-y-4">
                  {(related as Pick<BlogPostRow, 'id' | 'title' | 'slug' | 'excerpt' | 'cover_image_url' | 'published_at'>[]).map((r) => (
                    ...
                    >
                      ...
                      {r.published_at && (
                        <p className="mt-1 font-heading text-[0.6rem] font-medium text-gray-400">
